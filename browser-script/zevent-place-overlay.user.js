...
(() => {
  ...
  // _ekgtx9x8l:src/template/panel.html
  var panel_default = `<div id="zevent-place-overlay-ui-head">\r
    ...
    Overlays\r
    <span id="zevent-place-overlay-ui-version" style="color: gray; font-size: 70%; padding-left: 1em"></span>\r
            ...
            <div class="zpo-section-title">\r
                ...
                >Overlays actifs\r
                    <span\r
                            ...
                            style="color: gray; font-size: 70%; padding-left: 1em"\r
                    ></span\r
                    ></span>\r
        ...
        <div>\r
            ...
            <div class="zpo-section-subtitle">\r
                ...
                <a\r
                        ...
                        target="_blank"\r
                        style="text-decoration: underline; color: #8ab4f8"\r
...
`;
  ...
  // _ekgtx9x8l:src/template/knownOverlay.html
  ...
  // _ekgtx9x8l:src/template/wantedOverlay.html
...
`;
  ...
  // _ekgtx9x8l:src/template/overlayDescription.html
  ...
  // _ekgtx9x8l:src/template/update.html
  ...
  // _gbh48reb6:src/template/styles.css
