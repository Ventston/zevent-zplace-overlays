...
(() => {
  ...
  // _p2txq608x:src/template/panel.html
...
`;
  ...
  // _p2txq608x:src/template/settings.html
...
`;
  ...
  // _p2txq608x:src/template/knownOverlay.html
  ...
  // _p2txq608x:src/template/wantedOverlay.html
...
`;
  ...
  // _p2txq608x:src/template/overlayDescription.html
  ...
  // _p2txq608x:src/template/update.html
  ...
  // _lix9g0k9o:src/template/styles.css
