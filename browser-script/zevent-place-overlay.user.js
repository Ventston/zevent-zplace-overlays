...
(() => {
  ...
  // _cdalodixc:src/template/panel.html
...
`;
  ...
  // _cdalodixc:src/template/settings.html
...
`;
  ...
  // _cdalodixc:src/template/knownOverlay.html
  ...
  // _cdalodixc:src/template/wantedOverlay.html
...
`;
  ...
  // _cdalodixc:src/template/overlayDescription.html
  ...
  // _cdalodixc:src/template/update.html
  ...
  // _cdalodixc:src/template/message.html
  ...
  // _msdlirbpr:src/template/styles.css
